...
const MenProducts = () => {
    return (
        <Grid container item justifyContent="center" spacing={2} xs={12} marginLeft={12}>
            <Grid item xs={12}>
            ...
            <Grid item container xs={12}>
                <Typography variant='h6' sx={{ fontWeight: 'inherit', letterSpacing: 1 }}> Refine Search </Typography>
